...
<Center>
<title>Auction Creation Part 2 Shirt SQL</title>
</head>
<body>
	<%
	try {
		...
		if(newName == null || newName == ""){
			out.println("Clothing Name can't be empty <a href='AuctionCreationPart2Shirt.jsp'>try again</a>");
		...
		if(newBrand == null || newBrand == ""){
			out.println("Brand can't be empty <a href='AuctionCreationPart2Shirt.jsp'>try again</a>");
		...
		if(newGender == null || newGender == ""){
			out.println("Gender can't be empty <a href='AuctionCreationPart2Shirt.jsp'>try again</a>");
		...
		if(newColor == null || newColor == ""){
			out.println("Color can't be empty <a href='AuctionCreationPart2Shirt.jsp'>try again</a>");
		...
		String newShirtWidth = request.getParameter("newShirtWidth");
					
		if(newShirtWidth == null || newShirtWidth == ""){
			out.println("Shirt Width can't be empty <a href='AuctionCreationPart2Shirt.jsp'>try again</a>");
		...
		String newShirtLength = request.getParameter("newShirtLength");
		
		if(newShirtLength == null || newShirtLength == ""){
			out.println("Shirt Length can't be empty <a href='AuctionCreationPart2Shirt.jsp'>try again</a>");
		...
		if(newInitialPrice == null || newInitialPrice == ""){
			out.println("Initial Price can't be empty <a href='AuctionCreationPart2Shirt.jsp'>try again</a>");
		...
		if(newMinBid == null || newMinBid == ""){
			out.println("Bid Increment can't be empty <a href='AuctionCreationPart2Shirt.jsp'>try again</a>");
		...
		if(newSecretBidPrice == null || newSecretBidPrice == ""){
			out.println("Minimum Price can't be empty <a href='AuctionCreationPart2Shirt.jsp'>try again</a>");
		...
		if(newCloseOutDate == null || newCloseOutDate == ""){
			out.println("Close Out Date can't be empty <a href='AuctionCreationPart2Shirt.jsp'>try again</a>");
		...
		for(int i=0; i<newShirtWidth.length(); i++){
			if(newShirtWidth.charAt(i) < '0' || newShirtWidth.charAt(i) > '9'){
				if(newShirtWidth.charAt(i) == '.' && count == 0){
					count++;
				}
				else{
					out.println("Shirt Width must be a real number <a href='AuctionCreationPart2Shirt.jsp'>try again</a>");
		...
		for(int i=0; i<newShirtLength.length(); i++){
			if(newShirtLength.charAt(i) < '0' || newShirtLength.charAt(i) > '9'){
				if(newShirtLength.charAt(i) == '.' && count == 0){
					count++;
				}
				else{
					out.println("Shirt Length must be a real number <a href='AuctionCreationPart2Shirt.jsp'>try again</a>");
		...
		for(int i=0; i<newInitialPrice.length(); i++){
			if(newInitialPrice.charAt(i) < '0' || newInitialPrice.charAt(i) > '9'){
				out.println("Initial Price must be an integer <a href='AuctionCreationPart2Shirt.jsp'>try again</a>");
		...
		for(int i=0; i<newMinBid.length(); i++){
			if(newMinBid.charAt(i) < '0' || newMinBid.charAt(i) > '9'){
				out.println("Bid Increment must be an integer <a href='AuctionCreationPart2Shirt.jsp'>try again</a>");
		...
		for(int i=0; i<newSecretBidPrice.length(); i++){
			if(newSecretBidPrice.charAt(i) < '0' || newSecretBidPrice.charAt(i) > '9'){
				out.println("Minimum Sell Price must be an integer <a href='AuctionCreationPart2Shirt.jsp'>try again</a>");
		...
		if(newCloseOutDate.length() != 19){
			out.println("Close Out Date must have 19 characters <a href='AuctionCreationPart2Shirt.jsp'>try again</a>");
		...
		for(int i=0; i<newCloseOutDate.length(); i++){
			if(i < 4 && (newCloseOutDate.charAt(i) < '0' || newCloseOutDate.charAt(i) > '9')){
				out.println("Close Out Date year portion must be in integers <a href='AuctionCreationPart2Shirt.jsp'>try again</a>");
				...
				out.println("Close Out Date must contain - after year <a href='AuctionCreationPart2Shirt.jsp'>try again</a>");
				...
				out.println("Close Out Date month first month number must be between 0 and 1 <a href='AuctionCreationPart2Shirt.jsp'>try again</a>");
				...
				out.println("Close Out Date month can't have 00 months <a href='AuctionCreationPart2Shirt.jsp'>try again</a>");
				...
				out.println("Close Out Date month second month number must be between 0 and 2 when first month number is 1 <a href='AuctionCreationPart2Shirt.jsp'>try again</a>");
				...
				out.println("Close Out Date month second month number must be an integer <a href='AuctionCreationPart2Shirt.jsp'>try again</a>");
				...
				out.println("Close Out Date must contain - after months <a href='AuctionCreationPart2Shirt.jsp'>try again</a>");
				...
				out.println("Close Out Date day first day number must be between 0 and 3 <a href='AuctionCreationPart2Shirt.jsp'>try again</a>");
				...
				out.println("Close Out Date day can't have 00 days <a href='AuctionCreationPart2Shirt.jsp'>try again</a>");
				...
				out.println("Close Out Date day can't have more than 31 days <a href='AuctionCreationPart2Shirt.jsp'>try again</a>");
				...
				out.println("Close Out Date day second day number must be between 0 and 9 <a href='AuctionCreationPart2Shirt.jsp'>try again</a>");
				...
				out.println("Close Out Date must contain a space after days <a href='AuctionCreationPart2Shirt.jsp'>try again</a>");
				...
				out.println("Close Out Date hours first hour number must be between 0 and 2 <a href='AuctionCreationPart2Shirt.jsp'>try again</a>");
				...
				out.println("Close Out Date hours second hour number must be between 0 and 3 when first hour number is 2 <a href='AuctionCreationPart2Shirt.jsp'>try again</a>");
				...
				out.println("Close Out Date hours second hour number must be and integer <a href='AuctionCreationPart2Shirt.jsp'>try again</a>");
				...
				out.println("Close Out Date day must have : after hours portion <a href='AuctionCreationPart2Shirt.jsp'>try again</a>");
				...
				out.println("Close Out Date minutes first minute number must be and integer between 0 and 5 <a href='AuctionCreationPart2Shirt.jsp'>try again</a>");
				...
				out.println("Close Out Date minutes second minute number must be and integer <a href='AuctionCreationPart2Shirt.jsp'>try again</a>");
				...
				out.println("Close Out Date day must have : after minutes portion <a href='AuctionCreationPart2Shirt.jsp'>try again</a>");
				...
				out.println("Close Out Date seconds first second number must be and integer between 0 and 5 <a href='AuctionCreationPart2Shirt.jsp'>try again</a>");
				...
				out.println("Close Out Date seconds second second number must be and integer <a href='AuctionCreationPart2Shirt.jsp'>try again</a>");
		...
		//If the clothing combination isn't in the table then it is inserted, else we check the Shirts table to see if the same CID, length and width match
		...
		if(checkCID == 0){
			...
			//Converts the shirt width string into a float
			float shirtWidthSize = Float.parseFloat(newShirtWidth);
			
			//Converts the shirt length string into a float
			float shirtLengthSize = Float.parseFloat(newShirtLength);
								
			//Make an insert statement for the Shirt table:
			String insert2 = "INSERT INTO Shirt(CID, ShirtWidth, ShirtLength)"
					+ "VALUES (?, ?, ?)";
			...
			ps2.setFloat(2, shirtWidthSize);
			ps2.setFloat(3, shirtLengthSize);
			ps2.executeUpdate();	
		}
		else{
			//Pulls the CID 
			r = stmt.executeQuery("SELECT CID FROM Shirt WHERE CID ='" + checkCID + "'" + " AND ShirtWidth ='" + newShirtWidth + "'" + " AND ShirtLength ='" + newShirtLength + "'");
		...
		ResultSet rs;
		rs = stmt.executeQuery("SELECT * FROM Interests WHERE Shirt = '" + shirts + "'");
		while(rs.next()){
			String alert = "Here is a new auction that we are showing you based on your interest in SHIRTS";
