...
background-color: #E6E6FA
   ...
   <body>
      ...
      <sql:setDataSource var = "snapshot" driver = "com.mysql.jdbc.Driver"
 	  ...
 	  <%String filter_name = request.getParameter("Type"); 
 	  	request.setAttribute("filter_name", filter_name);%>
 	  <c:set var = "empId" value ="${filter_name}"/>
      ...
      JOIN Bids b on b.AID = a.AID WHERE WinnerUsername is null AND NAME = ? GROUP BY a.AID
